...
export const useTerraAssetsFlat = <T>(
  path: string,
  disabled = false,
  callback?: (data: T) => T,
) => {
...
export const useIBCWhitelist = () => {
  return useTerraAssetsFlat<IBCWhitelist>("ibc/tokens.json")
}

export const useCW20Contracts = () => {
  return useTerraAssetsFlat<CW20Contracts>("cw20/contracts.json")
}

export const useCW20Whitelist = (disabled = false) => {
  return useTerraAssetsFlat<CW20Whitelist>(
    "cw20/tokens.json",
    disabled,
...
export const useCW20Pairs = () => {
  return useTerraAssetsFlat<CW20Pairs>("cw20/pairs.dex.json")
}
...
export const useTerraContracts = () => {
  return useTerraAssetsFlat<TerraContracts>("contracts.json")
}

export const useCW721Whitelist = () => {
  return useTerraAssetsFlat<CW721Whitelist>(
